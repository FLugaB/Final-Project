...
route.get(
  ...
  TransactionController.clientTickets
);
// ini setelah pilih dokter client ngepatch voucher ticket untuk  dokter id dan voucher token
route.patch(
  "/account/tickets/:DoctorId",
  [authentication, authorization],
  TransactionController.clientTicketsDoctors
);
...
route.get(
  "/account/cart",
  [authentication, authorization],
  TransactionController.clientCart
);

// cek orderPorduct with id sesuai yg login then show (CHECKOUT DATA)
// OR Create New Transaction basedOn orderPorduct
route.get(
  "/account/detail-checkout",
  [authentication, authorization],
  TransactionController.clientDetailCheckout
);

// melakukan pembayaran
route.post(
  "/account/payment",
  [authentication, authorization, TransactionController.checkoutMid],
  requestSnapToken
);
...
route.get(
  ...
  [authentication, authorization],
  TransactionController.fetchStatusTransactions
);
...
route.post(
  ...
  TransactionController.notificationTransaction
);
